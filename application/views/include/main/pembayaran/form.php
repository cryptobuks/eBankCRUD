                ...
                <form>
                    <div class="form-group">
                        <select id="valueselect" class="form-control" >
                            ...
                            <option value="Pembayaran Internet">Pembayaran Internet</option>
                            <option value="Pembayaran Kartu Kredit">Pembayaran Kartu Kredit</option>
                    ...
                    <div class="form-group">
                        ...
                        <span id="textWarningNumber" class="col-sm-12 col-xs-12 text-center" style="padding-bottom: 20px;">
                            <h5 style="color: #5bb982;">
                                ...
                                Nomor Rekening Tidak Valid&nbsp
                        ...
                        <span id="textWarningNumberNot" class="col-sm-12 col-xs-12 text-center" style="padding-bottom: 20px;">
                            <h5 style="color: #5bb982;">
                                <i class="fa fa-exclamation-triangle" aria-hidden="true">&nbsp</i>
                                Pilih Menu:  <span class="typcn typcn-arrow-forward"></span>Transfer  Untuk Transfer Ke sesama Rekening CRUD&nbsp
                                <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
                            </h5>
                        </span>
                    </div>
                    ...
                    <div class="widget-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-5 col-xs-6 control-label">Untuk Pembayaran:</label>
                                <div class="col-sm-7 col-xs-6">

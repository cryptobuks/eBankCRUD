...
<div class='row'>
    <div class='col-lg-6 col-lg-offset-3 col-xs-12'>
        ...
        <div class='widget widget-default'>
            <header class='widget-header'>Bukti Transaksi</header>
            <div class='widget-body'>
                <form class='form-horizontal' target='_blank' method="post" action="<?php echo base_url('index.php/buktiTr/makePDF')?>">
                    ...
                    <div class='form-group'>
                        ...
                        <label class='col-sm-5 col-xs-6 control-label'><?php if ($exist != 1 || $exist != 1 ){echo "Pembayaran :";} else{ echo "Nama Penerima:";} ?></label>
                        <div class='col-sm-7 col-xs-6'>
                            <p class='form-control-static' id='ownNumberTo'>
                                ...
                                if($exist == 1){
                                    ...
                                    echo "Pembayaran Internet";
                                    } else if($exist == 3){
                                    echo "Pembayaran Telepon";
                                    } else if($exist == 4){
                                    echo "Pembayaran Kartu Kredit";
                                    }
                                ?>
                            </p>
                        </div>
